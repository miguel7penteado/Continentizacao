...
Executar a imagem **mcr.microsoft.com/windows:10.0.17763.2928-amd6** em modo interativo:
```bash
docker run -it mcr.microsoft.com/windows:10.0.17763.2928-amd6 cmd
```
...
Salvar o container **ooo** como **imagem1**:
```bash
docker commit keen_gauss imagem1
```
